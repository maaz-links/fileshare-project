...
VALUES
	(1,'Droppy','Droppy - Online file sharing','Online file sharing','','','false','droppy',1024,1,10,2,'',1209600,'uploads/','assets/img/icon.png','assets/img/logo.png','assets/img/logo.png','english',5,'no','mail','','true','','yes','No-Reply Droppy','noreply@yourdomain.com','','LOCAL','','true','tls',587,'','','','','false','','false','','','2.6.1',0,0);
