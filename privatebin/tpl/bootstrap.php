...
if (!$isDark) :
?>
		<link type="text/css" rel="stylesheet" href="privatebin/css/bootstrap/bootstrap-3.4.1.css" />
<?php
endif;
?>
		<link type="text/css" rel="stylesheet" href="privatebin/css/bootstrap/bootstrap-theme-3.4.1.css" />
<?php
if ($isDark) :
?>
		<link type="text/css" rel="stylesheet" href="privatebin/css/bootstrap/darkstrap-0.9.3.css" />
<?php
endif;
?>
		<link type="text/css" rel="stylesheet" href="privatebin/css/bootstrap/privatebin.css?<?php echo rawurlencode($VERSION); ?>" />
<?php
if ($SYNTAXHIGHLIGHTING) :
?>
		<link type="text/css" rel="stylesheet" href="privatebin/css/prettify/prettify.css?<?php echo rawurlencode($VERSION); ?>" />
<?php
    if (!empty($SYNTAXHIGHLIGHTINGTHEME)) :
?>
		<link type="text/css" rel="stylesheet" href="privatebin/css/prettify/<?php echo rawurlencode($SYNTAXHIGHLIGHTINGTHEME); ?>.css?<?php echo rawurlencode($VERSION); ?>" />
<?php
    endif;
endif;
?>
		<noscript><link type="text/css" rel="stylesheet" href="privatebin/css/noscript.css" /></noscript>
		<?php $this->_scriptTag('privatebin/js/jquery-3.7.1.js', 'defer'); ?>
<?php
if ($QRCODE) :
?>
		<?php $this->_scriptTag('privatebin/js/kjua-0.9.0.js', 'async'); ?>
<?php
endif;
if ($ZEROBINCOMPATIBILITY) :
?>
		<?php $this->_scriptTag('privatebin/js/base64-1.7.js', 'async'); ?>
<?php
endif;
?>
		<?php $this->_scriptTag('privatebin/js/zlib-1.3.1.js', 'async'); ?>
		<?php $this->_scriptTag('privatebin/js/base-x-4.0.0.js', 'defer'); ?>
		<?php $this->_scriptTag('privatebin/js/rawinflate-0.3.js', 'defer'); ?>
		<?php $this->_scriptTag('privatebin/js/bootstrap-3.4.1.js', 'defer'); ?>
<?php
if ($SYNTAXHIGHLIGHTING) :
?>
		<?php $this->_scriptTag('privatebin/js/prettify.js', 'async'); ?>
<?php
endif;
if ($MARKDOWN) :
?>
		<?php $this->_scriptTag('privatebin/js/showdown-2.1.0.js', 'async'); ?>
<?php
endif;
?>
		<?php $this->_scriptTag('privatebin/js/purify-3.1.7.js', 'async'); ?>
		<?php $this->_scriptTag('privatebin/js/legacy.js', 'async'); ?>
		<?php $this->_scriptTag('privatebin/js/privatebin.js', 'defer'); ?>
		<!-- icon -->
		<link rel="apple-touch-icon" href="<?php echo I18n::encode($BASEPATH); ?>privatebin/img/apple-touch-icon.png" sizes="180x180" />
		<link rel="icon" type="image/png" href="privatebin/img/favicon-32x32.png" sizes="32x32" />
		<link rel="icon" type="image/png" href="privatebin/img/favicon-16x16.png" sizes="16x16" />
...
?>
			<div class="navbar-header">
				...
				<a class="reloadlink navbar-brand" href="">
					<img alt="<?php echo I18n::_($NAME); ?>" src="privatebin/img/icon.svg" width="38" />
				</a>
			</div>
